...
rankingType = 'AUC'; %'AUC';%AUC, threshod
...
rankingType = 'threshold'; %'AUC';%AUC, threshod
...
for i=1:length(metricTypeSet)
    ...
    if strcmp(metricType,'overlap')&strcmp(rankingType,'threshold')
        continue;
    end
...
figureNames = {'SuccessSRE', 'SuccessTRE', 'PrecisionSRE', 'PrecisionTRE', 'FPS_TRE', 'FPS_SRE'};
for i=1:6
    figure1=figure(i);
    saveas(figure1, [figPath figureNames{i} '_IR_all.eps'],'epsc');
end